'''
Main code copy from sample code about get language lists at Microsoft speech API
Now we just use its 'get_supported_languages' function
'''
import requests
import uuid
...
def list_supported_languages(localizeTo='zh-Hans'):
